...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0B0E1A", color: "#EAECF5",
      ...
      <div style={{ width: 320, padding: 28, background: "#161B33",
...
const inp = { width: "100%", padding: "10px 12px", marginBottom: 8, borderRadius: 8,
  background: "#0B0E1A", border: "1px solid #262C4A", color: "#EAECF5",
  outline: "none", boxSizing: "border-box", fontSize: 14 };
const btn = { flex: 1, padding: "10px", borderRadius: 8, border: "none",
